export default {
  ...
  meta: {
    ...
    // ogUrl: false,
    ogTitle: 'Cashmere-Solutions - Free Virtual Buisness Card',
    ogDescription:
      'EnBizCard helps you create beautiful, responsive HTML-based digital business cards that can be hosted on your website.',
    ogSiteName: 'Cashmere-Solutions - Free Virtual Buisness Card',
    theme_color: '#111827',
    author: 'Vishnu Raghav',
    lang: 'en',
    name: 'Cashmere-Solutions - Free Virtual Buisness Card',
  },
  head: {
