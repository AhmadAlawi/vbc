    ...
    <div :id="`Theme${theme}`">
      ...
      >
        <head>
          ...
          <meta
            name="author"
            content="cashmere-solutions -Free Digital Business Card Generator"
          />
          <meta name="url" content="https://cashmere-solutions.com/" />
          <meta name="designer" content="Cashmere-Solutions" />
          <meta
            property="og:title"
        ...
        <body id="body">
          ...
          >
            ...
            <a
              class="textColor"
              href="https://cashmere-solutions.com/"
              target="_blank"
              rel="noopener noreferrer"
              >Cashmere-Solutions</a
            >
          </footer>
        </body>
      </html>
