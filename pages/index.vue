    ...
    <div class="px-4">
      <div class="flex items-start justify-between pt-8">
        <div
          ...
          title="Cashmere-Solutions - Free Virtual Buisness Card"
        ></div>
        <a
          class="
            font-extrabold
            ...
            duration-200
          "
          href="https://www.cashmere-solutions.com/contact"
          target="_blank"
          rel="noreferrer"
          >Contact</a
        >
      ...
      <p class="mt-8 text-lg md:text-xl w-full md:w-3/4 text-gray-200">
        cashmere-solutions helps you create beautiful, responsive HTML&#8209;based
      ...
      <div class="px-4 mt-32">
        ...
        <div id="step-6" class="mt-16">
          ...
          <div class="stepC mt-6" >
            ...
            <p class="mt-6 border p-4 rounded border-gray-700 text-gray-400">
              Contact Us to remove the footer credit.
            </p>
          </div>
        </div>
          ...
          <div class="stepC mt-6">
            ...
            <input
              ...
              class="
                ...
                hover:border-gray-600
              "
              placeholder="https://yoursite/vbc/username"
            />
            <p class="mt-6 border p-4 rounded border-gray-700 text-gray-400">
              ...
              >
                <div id="searchField" class="p-2 flex items-center">
                  <input
                    ...
                    disabled
                    :value="'https://yoursite/vbc/' + username"
                    tabindex="-1"
                  />
                  <div
                    class="w-6 ml-2"
