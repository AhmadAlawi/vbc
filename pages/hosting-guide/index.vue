    ...
    <div class="px-4">
      <div class="flex items-start justify-between pt-8">
        <NuxtLink to="/">
          <div
            ...
            title="Cashmere-Solutions - Free Digital Business Card Generator"
          ></div
        ></NuxtLink>
      ...
      <div id="guide" class="max-w-screen-sm">
        ...
        <p class="mt-16 border px-4 py-3 rounded border-gray-700">
          ...
          "<span class="font-extrabold">Cashmere-Solutions folder</span>" throughout this
          guide.
        </p>
        ...
        <div class="mt-16">
          ...
          <ul class="px-6 mt-6 list-outside list-disc">
            ...
            <li>
              Upload your Vcard folder into the new folder that you just
              created in the previous step.
            </li>
            <li>
              Now your business card should be online at the address
              https://your-domain.com/ Vcard/card-folder-name/ and is ready to
              be shared.
            </li>
          </ul>
        </div>
        ...
        <div class="mt-16">
          ...
          <ul class="px-6 mt-6 list-outside list-disc">
            ...
            <li>
              ...
              <a
                class="underline font-extrabold text-emerald-600 hover:text-emerald-500 focus:text-emerald-500 transition-colors duration-200"
                href="https://Cashmere-Solutions.com/hosting-guide"
                target="_blank"
                >Hosting Guide</a
              >.
            </li>
        ...
        <div class="mt-16">
          ...
          <ul class="px-6 mt-6 list-outside list-disc">
            ...
            <li>Copy the VbCard folder inside the "Vcard" folder.</li>
            <li>Commit changes and deploy.</li>
            <li>
              Now the business card should be online at the address
              https://your-domain/Vcard/Vcard-folder/ and is ready to be
              shared.
            </li>
          </ul>
        </div>
        <div class="mt-16">
          ...
          <ul class="px-6 mt-6 list-outside list-disc">
            ...
            <li>
              Once done, copying your Vcard folder into a respective folder is
          ...
          <p class="mt-4">
            ...
            <a
              ...
              href="https://cashmere-solutions.com/contact"
              target="_blank"
              rel="noopener noreferrer"
              >Contact Us</a
            >
        ...
        <div class="mt-16">
          ...
          <p class="mt-6">
            Cashmere-Solutions does not store any data online for you to retrieve it for
          ...
          <ul class="px-6 mt-6 list-outside list-disc">
            ...
            <li>
              Extract the downloaded ZIP file and copy your  Vcard folder
        ...
        <div class="mt-16">
          ...
          <ul class="px-6 mt-6 list-outside list-disc">
            ...
            <li>
              Extract the downloaded ZIP file and copy the Vcard folder.
            </li>
            <li>
              Follow the exact same steps as per your category listed above to
